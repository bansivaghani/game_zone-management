...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/modal.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:42:02 GMT -->
<head>
            ...
            <div class="row">
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <p>This <a class="btn btn-primary popover-test" href="#" role="button" title="Popover body content is set in this attribute." data-container="#exampleModalPopovers">button</a> triggers a popover on click.</p>
                            <hr>
                            <h5>Tooltips in a modal</h5>
                            <p><a class="tooltip-test" href="#" title="Tooltip" data-container="#exampleModalPopovers">This link</a> and <a class="tooltip-test" href="#" title="Tooltip" data-container="#exampleModalPopovers">that link</a> have tooltips on hover.</p>
                          </div>
                          <div class="modal-footer">
                            <button class="btn btn-secondary" type="button" data-bs-dismiss="modal">Close</button>
                            <button class="btn btn-primary" type="button">Save changes</button>
              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body btn-showcase">
                    <!-- xtra Large modal-->
                    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target=".bd-example-modal-xl">Extra Large modal</button>
