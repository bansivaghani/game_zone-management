...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/datatable-ext-row-reorder.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:42:00 GMT -->
<head>
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
                    <h5 class="mb-3">Restricted column ordering</h5><span>This example shows that RowReorder will be used in, as ordering by other columns can make the reordering potentially quite confusing for the end user.</span>
                  </div>
                  <div class="card-body">
                    <div class="dt-ext table-responsive">
