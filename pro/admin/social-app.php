...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/social-app.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:41:42 GMT -->
<head>
            ...
            <div class="user-profile social-app-profile">
              ...
              <div class="tab-content" id="top-tabContent">
                <div class="tab-pane fade show active" id="timeline" role="tabpanel" aria-labelledby="timeline">
                  <div class="row">
                    <div class="col-xl-3 xl-40 col-md-5 box-col-5">
                              ...
                              <div class="collapse show" id="collapseicon" aria-labelledby="collapseicon" data-parent="#accordion">
                                <div class="card-body socialprofile filter-cards-view">
                                  <div class="media"><img class="img-50 img-fluid m-r-20 rounded-circle" src="../assets/images/user/1.jpg" alt="">
                                    <div class="media-body">
                                      <h5 class="font-primary f-w-600">My Page</h5><span class="d-block"><span><i class="fa fa-comments-o"> </i><span class="px-2">Messages<span class="badge badge-pill badge-light ms-1">9</span></span></span></span><span class="d-block"><span><i class="fa fa-bell-o"> </i><span class="px-2">Notification<span class="badge badge-pill badge-light ms-1">9</span></span></span></span>
                                    </div>
                                  </div>
                              ...
                              <div class="collapse show" id="collapseicon1" data-parent="#accordion" aria-labelledby="collapseicon1">
                                <div class="card-body social-status filter-cards-view">
                                  ...
                                  <div class="media"><img class="img-50 rounded-circle m-r-15" src="../assets/images/user/2.png" alt="">
                                    ...
                                    <div class="media-body"><a href="user-profile.html"><span class="f-w-600 d-block">Bucky Barnes</span></a><span class="d-block">winter@gmail.com</span></div>
                                  </div>
                                  <div class="media"><img class="img-50 rounded-circle m-r-15" src="../assets/images/user/10.jpg" alt="">
                                    ...
                                    <div class="media-body"><a href="user-profile.html"><span class="f-w-600 d-block">Sarah Loren</span></a><span class="d-block">barnes@gmail.com</span></div>
                                  </div>
                                  <div class="media"><img class="img-50 rounded-circle m-r-15" src="../assets/images/user/6.jpg" alt="">
                                    ...
                                    <div class="media-body"><a href="user-profile.html"><span class="f-w-600 d-block">Jason Borne</span></a><span class="d-block">jasonb@gmail.com</span></div>
                                  </div>
                                  <div class="media"><img class="img-50 rounded-circle m-r-15" src="../assets/images/user/8.jpg" alt="">
                                    <div class="social-status social-offline"></div>
                                    <div class="media-body"><a href="user-profile.html"><span class="f-w-600 d-block">Comeren Diaz</span></a><span class="d-block">comere@gmail.com</span></div>
                                  </div>
                                  <div class="media"><img class="img-50 rounded-circle m-r-15" src="../assets/images/user/14.png" alt="">
                                    <div class="social-status social-online"></div>
                                    <div class="media-body"><a href="user-profile.html"><span class="f-w-600 d-block">Andew Jon</span></a><span class="d-block">andrewj@gmail.com</span></div>
                                  </div>
                                  ...
                                  <div class="media"><img class="img-50 rounded-circle m-r-15" src="../assets/images/user/3.png" alt="">
                                    <div class="social-status social-offline"></div>
                                    <div class="media-body"><a href="user-profile.html"><span class="f-w-600 d-block">Johny William</span></a><span class="d-block">johnyw@gmail.com</span></div>
                                  </div>
                                  <div class="media"><img class="img-50 rounded-circle m-r-15" src="../assets/images/user/2.png" alt="">
                                    <div class="social-status social-online"></div>
                                    <div class="media-body"><a href="user-profile.html"><span class="f-w-600 d-block">Bucky Barnes</span></a><span class="d-block">winter@gmail.com</span></div>
                                  ...
                                  <div class="media"><img class="img-50 rounded-circle m-r-15" src="../assets/images/user/4.jpg" alt="">
                                    <div class="social-status social-busy"></div>
                                    <div class="media-body"><a href="user-profile.html"><span class="f-w-600 d-block">Johny Waston</span></a><span class="d-block">johny@gmail.com</span></div>
                                  </div>
                                  <div class="media"><img class="img-50 rounded-circle m-r-15" src="../assets/images/user/3.png" alt="">
                                    <div class="social-status social-offline"></div>
                                    <div class="media-body"><a href="user-profile.html"><span class="f-w-600 d-block">Johny William</span></a><span class="d-block">johnyw@gmail.com</span></div>
                          ...
                          <div class="col-md-12 col-sm-6">
                            <div class="card">
                              ...
                              <div class="collapse show" id="collapseicon12" aria-labelledby="collapseicon12" data-parent="#accordion">
                                <div class="card-body social-status filter-cards-view">
                                  <div class="media"><img class="img-50 rounded-circle m-r-15" src="../assets/images/user/10.jpg" alt="">
                                    <div class="media-body"><a href="user-profile.html"><span class="f-w-600 d-block">Andew Jon</span></a>
                                  ...
                                  <div class="media"><img class="img-50 rounded-circle m-r-15" src="../assets/images/user/3.jpg" alt="">
                                    <div class="media-body"><a href="user-profile.html"><span class="f-w-600 d-block">Johny Waston</span></a>
                                  ...
                                  <div class="media"><img class="img-50 rounded-circle m-r-15" src="../assets/images/user/5.jpg" alt="">
                                    <div class="media-body"><a href="user-profile.html"><span class="f-w-600 d-block">Comeren Diaz</span></a>
                                      <p>Commented on Shaun Park's <a href="javascript:void(0)">Photo</a></p><span class="light-span">1 days Ago</span>
                                    </div>
                                  </div>
                                  <div class="media"><img class="img-50 rounded-circle m-r-15" src="../assets/images/user/4.jpg" alt="">
                                    <div class="media-body"><a href="user-profile.html"><span class="f-w-600 d-block">Sarah Loren</span></a>
                    ...
                    <div class="col-xl-6 xl-60 col-md-7 box-col-7">
                      <div class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            <div class="card-body">
                              <div class="new-users-social">
                                <div class="media"><img class="rounded-circle image-radius m-r-15" src="../assets/images/user/1.jpg" alt="">
                                  <div class="media-body">
                                    ...
                                    <p>January, 12,2019</p>
                                  </div><span class="pull-right mt-2"><i data-feather="more-vertical"></i></span>
                                </div>
                            ...
                            <div class="card">
                              ...
                              <div class="collapse show" id="collapseicon3" aria-labelledby="collapseicon3" data-parent="#accordion">
                                <div class="card-body social-list filter-cards-view">
                                  <div class="media"><img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="../assets/images/user/2.png">
                                    <div class="media-body"><a href="user-profile.html"><span class="d-block">Bucky Barnes</span></a><a href="javascript:void(0)">Add Friend</a></div>
                                  </div>
                                  <div class="media"><img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="../assets/images/user/3.png">
                                    <div class="media-body"><a href="user-profile.html"><span class="d-block">Sarah Loren</span></a><a href="javascript:void(0)">Add Friend</a></div>
                                  </div>
                                  <div class="media"><img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="../assets/images/user/3.jpg">
                                    <div class="media-body"><a href="user-profile.html"><span class="d-block">Jason Borne</span></a><a href="javascript:void(0)">Add Friend</a></div>
                                  </div>
                                  <div class="media"><img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="../assets/images/user/10.jpg">
                                    <div class="media-body"><a href="user-profile.html"><span class="d-block">Comeren Diaz</span></a><a href="javascript:void(0)">Add Friend</a></div>
                                  </div>
                                  <div class="media"><img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="../assets/images/user/11.png">
                                    <div class="media-body"><a href="user-profile.html"><span class="d-block">Andew Jon</span></a><a href="javascript:void(0)">Add Friend</a></div>
                                  </div>
                                </div>
                              </div>
                            </div>
                ...
                <div class="tab-pane fade" id="about" role="tabpanel" aria-labelledby="about">
                  <div class="row">
                    <div class="col-xl-3 xl-40 col-lg-12 col-md-5 box-col-5">
                    ...
                    <div class="col-xl-6 xl-60 col-lg-12 col-md-7 box-col-7">
                      <div class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            <div class="card-header">
                              ...
                              <div class="row details-about">
                                ...
                                <div class="col-sm-6">
                                  <div class="your-details your-details-xs">
                                    ...
                                    <p>Swimming, Surfing, Szeta Diving, Anime, Photography, Tattoos, Street Art.</p>
                                  </div>
                                </div>
                              </div>
                            </div>
...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/social-app.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:41:49 GMT -->
</html>