...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/according.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:42:03 GMT -->
<head>
          ...
          <div class="container-fluid">
            <div class="row">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="default-according default-according-page" id="accordion">
                      ...
                      <div class="card">
                        <div class="card-header pb-0" id="headingThree">
                          <h5 class="mb-0">
                    ...
                    <div class="default-according" id="accordionclose">
                      <div class="card">
                        <div class="card-header pb-0" id="heading1">
                          <h5 class="mb-0">
                            <button class="btn btn-link" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="false" aria-controls="heading1">Collapsible Group Item #<span>1</span></button>
                          </h5>
                        </div>
                      ...
                      <div class="card">
                        <div class="card-header pb-0" id="heading2">
                          <h5 class="mb-0">
                      ...
                      <div class="card">
                        <div class="card-header pb-0" id="heading3">
                          <h5 class="mb-0">
                      ...
                      <div class="card">
                        <div class="card-header pb-0" id="heading4">
                          <h5 class="mb-0">
                      ...
                      <div class="card">
                        <div class="card-header pb-0" id="heading5">
                          <h5 class="mb-0">
              ...
              <div class="col-sm-12 col-md-6 col-xl-6">
                <div class="card">
                  <div class="card-header pb-0">
                    <h5>Color Accordion</h5><span>Add <code>.bg-*</code> class to add background color with card-header.pb-0.</span>
                  </div>
                  <div class="card-body">
                    <div class="default-according-page default-according" id="accordion1">
                      <div class="card">
                        <div class="card-header pb-0" id="headingFour">
                          <h5 class="mb-0">
                            <button class="btn btn-link text-white bg-primary" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">Collapsible Group Item #<span>1</span></button>
                          </h5>
                        </div>
                      ...
                      <div class="card">
                        <div class="card-header pb-0" id="headingFive">
                          <h5 class="mb-0">
                            <button class="btn btn-link collapsed text-white bg-primary" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">Collapsible Group Item #<span>2</span></button>
                          </h5>
                        </div>
                      ...
                      <div class="card">
                        <div class="card-header pb-0" id="headingSix">
                          <h5 class="mb-0">
                            <button class="btn btn-link collapsed text-white bg-primary" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">Collapsible Group Item #<span>3</span></button>
                          </h5>
                        </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="default-according" id="accordion2">
                      <div class="card">
                        <div class="card-header pb-0" id="headingseven">
                          <h5 class="mb-0">
                            <button class="btn btn-link text-white bg-secondary" data-bs-toggle="collapse" data-bs-target="#collapseseven" aria-expanded="true">Collapsible Group Item #<span>1</span></button>
                          </h5>
                        </div>
                      ...
                      <div class="card">
                        <div class="card-header pb-0" id="headingeight">
                          <h5 class="mb-0">
                            <button class="btn btn-link collapsed text-white bg-secondary" data-bs-toggle="collapse" data-bs-target="#collapseeight" aria-expanded="false" aria-controls="collapseeight">Collapsible Group Item #<span>2</span></button>
                          </h5>
                        </div>
                      ...
                      <div class="card">
                        <div class="card-header pb-0" id="headingnine">
                          <h5 class="mb-0">
                            <button class="btn btn-link collapsed text-white bg-secondary" data-bs-toggle="collapse" data-bs-target="#collapsenine" aria-expanded="false" aria-controls="collapsenine">Collapsible Group Item #<span>3</span></button>
                          </h5>
                        </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="default-according" id="accordionicon">
                      <div class="card">
                        <div class="card-header pb-0" id="heading11">
                          <h5 class="mb-0">
                            <button class="btn btn-link text-white bg-primary" data-bs-toggle="collapse" data-bs-target="#collapse11" aria-expanded="true" aria-controls="collapse11"><i class="icofont icofont-briefcase-alt-2"></i>Collapsible Group Item #<span>1</span></button>
                          </h5>
                        </div>
                      ...
                      <div class="card">
                        <div class="card-header pb-0" id="heading22">
                          <h5 class="mb-0">
                            <button class="btn btn-link collapsed text-white bg-primary" data-bs-toggle="collapse" data-bs-target="#collapse22" aria-expanded="false" aria-controls="collapse22"><i class="icofont icofont-support"></i>Collapsible Group Item #<span>2</span></button>
                          </h5>
                        </div>
                      ...
                      <div class="card">
                        <div class="card-header pb-0" id="heading33">
                          <h5 class="mb-0">
                            <button class="btn btn-link collapsed text-white bg-primary" data-bs-toggle="collapse" data-bs-target="#collapse44" aria-expanded="false" aria-controls="collapse44"><i class="icofont icofont-tasks-alt"></i>Collapsible Group Item #<span>3</span></button>
                          </h5>
                        </div>
                  ...
                  <div class="card-body">
                    <div class="default-according style-1" id="accordionoc">
                      <div class="card">
                        <div class="card-header pb-0">
                          <h5 class="mb-0">
                            <button class="btn btn-link text-white bg-primary" data-bs-toggle="collapse" data-bs-target="#collapseicon" aria-expanded="true" aria-controls="collapse11"><i class="icofont icofont-briefcase-alt-2"></i> Collapsible Group Item #<span>1</span></button>
                          </h5>
                        </div>
                      ...
                      <div class="card">
                        <div class="card-header pb-0">
                          <h5 class="mb-0">
                            <button class="btn btn-link collapsed text-white bg-primary" data-bs-toggle="collapse" data-bs-target="#collapseicon1" aria-expanded="false"><i class="icofont icofont-support"></i> Collapsible Group Item #<span>2</span></button>
                          </h5>
                        </div>
                      ...
                      <div class="card">
                        <div class="card-header pb-0">
                          <h5 class="mb-0">
                            <button class="btn btn-link collapsed text-white bg-primary" data-bs-toggle="collapse" data-bs-target="#collapseicon2" aria-expanded="false" aria-controls="collapseicon2"><i class="icofont icofont-tasks-alt"></i> Collapsible Group Item #<span>3</span></button>
                          </h5>
                        </div>
