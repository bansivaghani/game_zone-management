...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/job-cards-view.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:43:33 GMT -->
<head>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-xl-3 xl-40 box-col-5">
                <div class="job-sidebar md-sidebar"><a class="btn btn-primary md-sidebar-toggle" href="javascript:void(0)">job filter</a>
                    ...
                    <div class="card ribbon-vertical-left-wrapper">
                      ...
                      <div class="job-search">
                        <div class="card-body">
                          <div class="media"><img class="img-40 img-fluid m-r-20" src="../assets/images/job-search/2.jpg" alt="">
                            <div class="media-body">
                              <h6 class="f-w-600"><a href="job-details.html">React/React Native Developer </a><span class="pull-right">5 days ago</span></h6>
                              <p>San <span>Diego, CA</span></p>
                              <ul class="rating">
                                <li><i class="fa fa-star font-warning"></i></li>
                                <li><i class="fa fa-star font-warning"></i></li>
                    ...
                    <div class="card">
                      <div class="job-search">
                        <div class="card-body">
                          ...
                          <p>We are looking for an experienced and zeta designer and/or frontend engineer with expertise in accessibility to join our team , 3+ years of experience working in as a Frontend Engineer or comparable role. You won’t be a team of one though — you’ll be collaborating closely with other...</p>
                        </div>
                      </div>
                    </div>
                  </div>
...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/job-cards-view.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:43:34 GMT -->
</html>