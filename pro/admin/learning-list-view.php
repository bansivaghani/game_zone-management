...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/learning-list-view.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:43:34 GMT -->
<head>
          ...
          <div class="container-fluid">
            <div class="row learning-block">
              <div class="col-xl-9 xl-60">
                <div class="row">
                  ...
                  <div class="col-xl-12 col-sm-6">
                    <div class="card">
                      <div class="blog-box blog-list row">
                        <div class="col-xl-5 col-12"><img class="img-fluid sm-100-w" src="../assets/images/faq/2.jpg" alt=""></div>
                        <div class="col-xl-7 col-12">
                          <div class="blog-details">
                            <div class="blog-date"><span>10</span> March 2019</div><a href="learning-detailed.html">
                      ...
                      <div class="product-box learning-box">
                        <div class="product-img"><img class="img-fluid top-radius-blog" src="../assets/images/faq/3.jpg" alt="">
                          <div class="product-hover">
                            <ul>
                              <li><a href="learning-detailed.html"><i class="icon-link"></i></a></li>
                              <li><a href="learning-detailed.html"><i class="icon-import"></i></a></li>
                            </ul>
                          </div>
                        </div>
              ...
              <div class="col-xl-3 xl-40">                
                <div class="job-sidebar md-sidebar"><a class="btn btn-primary md-sidebar-toggle" href="javascript:void(0)">learning filter</a>
                              ...
                              <div class="upcoming-course card-body">
                                <div class="media">
                                  <div class="media-body">
                                    ...
                                    <p class="mb-0">Course By <a href="#"> Lorem ipsum</a></p>
                                    <ul class="rating">
