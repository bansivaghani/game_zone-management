...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/datatable-ext-html-5-data-export.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:42:00 GMT -->
<head>
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
                    <h5 class="mb-3">Column Selectors</h5><span>All of the data export buttons have a exportOptions option which can be used to specify information about what data should be exported and how. The options given for this parameter are passed directly to the buttons.exportData() method to obtain the required data.</span>
                  </div>
                  <div class="card-body">
                    <div class="dt-ext table-responsive">
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
                    <h5 class="mb-3">Excel - Customise borders</h5><span>This example demonstrates how to manipulate the file using this method to add a styling attribute to a row in the XML used to create the XSLX file.</span>
                  </div>
                  <div class="card-body">
                    <div class="dt-ext table-responsive">
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
                    <h5 class="mb-3">Custom file (JSON)</h5><span>Buttons uses the excellent FileSaver.js by Eli Grey in order to be able to create and download files on the client-side (i.e. for the CSV and Excel button types). Buttons' built in FileSaver.js is exposed via $.fn.dataTable.fileSave() when the HTML5 button types file is loaded, and it can be used to easily create your own custom files.</span>
                  </div>
                  <div class="card-body">
                    <div class="dt-ext table-responsive">
