...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:42:42 GMT -->
<head>
              ...
              <div class="col-sm-12">
                <div class="card" id="default">
                  <div class="card-header pb-0">
                    <h5>Default buttons</h5><span>Bootstrap state buttons</span>
                  </div>
                  <div class="card-body"> 
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                  <div class="card-header pb-0">
                    <h5>flat button</h5><span>Add <code>.btn-square</code> class for flat button</span>
                  </div>
                  <div class="card-body"> 
                    <div class="btn-showcase">
...
&lt;!-- Cod Box Copy end --&gt; </code></pre>
                ...
                <div class="card">
                  <div class="card-header pb-0">
                    <h5>Edge button</h5><span>Add <code>.btn-pill</code> class for edge button</span>
                  </div>
                  <div class="card-body"> 
                    <div class="btn-showcase">
...
&lt;!-- Cod Box Copy end --&gt;                             </code></pre>
                ...
                <div class="card">
                  <div class="card-header pb-0">
                    <h5>Raised buttons</h5><span>Add <code>.btn-pill</code> and <code>.btn-air-*</code> class  for raised button</span>
                  </div>
                  <div class="card-body"> 
                    <div class="btn-showcase">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card" id="large-btn">
                  <div class="card-header pb-0">
                    <h5>Large buttons</h5><span>Add <code>.btn-lg</code> class for large size buttons</span>
                  </div>
                  <div class="card-body"> 
                    <div class="btn-showcase">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card" id="small-btn">
                  <div class="card-header pb-0">
                    <h5>Small buttons</h5><span>Add <code>.btn-sm</code> class for small size buttons</span>
                  </div>
                  <div class="card-body"> 
                    <div class="btn-showcase">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card" id="ex-small-btn">
                  <div class="card-header pb-0">
                    <h5>Extra Small buttons</h5><span>Add <code>.btn-xs</code> class for extra small size buttons</span>
                  </div>
                  <div class="card-body"> 
                    <div class="btn-showcase">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card" id="active-btn">
                  <div class="card-header pb-0">
                    <h5>Active Buttons</h5><span>Add <code>.active</code> class for active state</span>
                  </div>
                  <div class="card-body"> 
                    <div class="btn-showcase">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card" id="disabled-btn">
                  <div class="card-header pb-0">
                    <h5>Disabled buttons</h5><span>Add <code>.disabled</code> class or <code>disabled="disabled"</code> attribute for disabled button</span>
                  </div>
                  <div class="card-body"> 
                    <div class="btn-showcase">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card" id="outline-button">
                  <div class="card-header pb-0">
                    <h5>outline buttons</h5><span>Add <code>.btn-outline-*</code> class for border button</span>
                  </div>
                  <div class="card-body"> 
                    <div class="btn-showcase">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card" id="outline-bold-button">
                  <div class="card-header pb-0">
                    <h5>bold Border outline buttons</h5><span>Add <code>.btn-outline-*-2x</code> class for bold outline</span>
                  </div>
                  <div class="card-body"> 
                    <div class="btn-showcase">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card" id="gradiant">
                  <div class="card-header pb-0">
                    <h5>Gradien buttons</h5><span>Add <code>.btn-*-gradien</code> class for gradien button</span>
                  </div>
                  <div class="card-body"> 
                    <div class="btn-showcase">
...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:42:43 GMT -->
</html>