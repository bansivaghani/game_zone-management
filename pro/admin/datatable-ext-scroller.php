...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/datatable-ext-scroller.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:42:00 GMT -->
<head>
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
                    <h5 class="mb-3">State Saving</h5><span>Scroller will automatically integrate with DataTables in order to save the scrolling position of the table, if state saving is enabled in the DataTable (stateSave). This example shows that in practice - to demonstrate, scroll the table and then reload the page.</span>
                  </div>
                  <div class="card-body">
                    <div class="dt-ext table-responsive">
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
                    <h5 class="mb-3">API</h5><span>This example shows a trivial use of the API methods that Scroller adds to the DataTables API to scroll to a row once the table's data has been loaded.</span>
                  </div>
                  <div class="card-body">
                    <div class="dt-ext table-responsive">
