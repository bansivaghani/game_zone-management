...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/switch.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:41:53 GMT -->
<head>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="row switch-showcase">
                      <div class="col-sm-12">
                        <div class="media">
                          <label class="col-form-label">Large Size</label>
                        ...
                        <div class="media">
                          <label class="col-form-label">Large Unhecked</label>
                          <div class="media-body text-end switch-lg">
                            <label class="switch">
                              <input type="checkbox"><span class="switch-state"></span>
                            </label>
                        ...
                        <div class="media">
                          <label class="col-form-label">Normal Size</label>
                          <div class="media-body text-end">
                            <label class="switch">
                              <input type="checkbox" checked=""><span class="switch-state"></span>
                            </label>
                        ...
                        <div class="media">
                          <label class="col-form-label">Normal Unhecked</label>
                          <div class="media-body text-end">
                            <label class="switch">
                              <input type="checkbox"><span class="switch-state"></span>
                            </label>
                        ...
                        <div class="media">
                          <label class="col-form-label">Small Size</label>
                        ...
                        <div class="media">
                          <label class="col-form-label">Small Size Unhecked</label>
                          <div class="media-body text-end switch-sm">
                            <label class="switch">
                              <input type="checkbox"><span class="switch-state"></span>
                            </label>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="row switch-showcase">
                      <div class="col-sm-12">
                        <div class="media">
                          <label class="col-form-label">Primary Color (Disabled)</label>
                          <div class="media-body text-end switch-lg icon-state">
                            <label class="switch">
