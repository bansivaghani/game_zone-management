...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/tag-pills.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:42:02 GMT -->
<head>
              ...
              <div class="col-sm-12 col-xl-6">
                <div class="card">
                  <div class="card-header pb-0">
                    <h5>Badge Variations</h5>
                  </div>
                  <div class="card-body"><span class="badge badge-primary">Primary</span><span class="badge badge-secondary">Secondary</span><span class="badge badge-success">Success</span><span class="badge badge-info">Info</span><span class="badge badge-warning text-dark">Warning</span><span class="badge badge-danger">Danger</span><span class="badge badge-light text-dark">Light</span><span class="badge badge-dark tag-pills-sm-mb">Dark</span>
                    <div class="pt-4"><a class="badge badge-primary" href="#"><i data-feather="dollar-sign"></i></a><a class="badge badge-secondary" href="#"><i data-feather="headphones"></i></a><a class="badge badge-success" href="#"><i data-feather="link"></i></a><a class="badge badge-info" href="#"><i data-feather="github"></i></a><a class="badge badge-warning text-dark" href="#"><i data-feather="award"></i></a><a class="badge badge-danger" href="#"><i data-feather="activity"></i></a><a class="badge badge-light text-dark" href="#"><i data-feather="heart"></i></a><a class="badge badge-dark" href="#"></a></div>
                    <div class="pt-4"><a class="badge badge-primary" href="#">1</a><a class="badge badge-secondary" href="#">2</a><a class="badge badge-success" href="#">3</a><a class="badge badge-info" href="#">4</a><a class="badge badge-warning text-dark" href="#">5</a><a class="badge badge-danger" href="#">6</a><a class="badge badge-light text-dark" href="#">7</a><a class="badge badge-dark" href="#">8</a></div>
                  </div>
                </div>
              </div>
              <div class="col-sm-12 col-xl-6">
                <div class="card">
                  <div class="card-header pb-0">
                    <h5>Rounded Badge Variations</h5>
                  </div>
                  <div class="card-body"><span class="badge rounded-pill badge-primary">Primary</span><span class="badge rounded-pill badge-secondary">Secondary</span><span class="badge rounded-pill badge-success">Success</span><span class="badge rounded-pill badge-info">Info</span><span class="badge rounded-pill badge-warning text-dark">Warning</span><span class="badge rounded-pill badge-danger">Danger</span><span class="badge rounded-pill badge-light text-dark">Light</span><span class="badge rounded-pill badge-dark tag-pills-sm-mb">Dark</span>
                    <div class="pt-4"><a class="badge rounded-pill badge-primary" href="#"><i data-feather="dollar-sign"></i></a><a class="badge rounded-pill badge-secondary" href="#"><i data-feather="headphones"></i></a><a class="badge rounded-pill badge-success" href="#"><i data-feather="link"></i></a><a class="badge rounded-pill badge-info" href="#"><i data-feather="github"></i></a><a class="badge rounded-pill badge-warning text-dark" href="#"><i data-feather="award"></i></a><a class="badge rounded-pill badge-danger" href="#"><i data-feather="activity"></i></a><a class="badge rounded-pill badge-light text-dark" href="#"><i data-feather="heart"></i></a><a class="badge rounded-pill badge-dark" href="#"><i data-feather="mail"></i></a></div>
                    <div class="pt-4"><span class="badge rounded-pill badge-primary">1</span><span class="badge rounded-pill badge-secondary">2</span><span class="badge rounded-pill badge-success">3</span><span class="badge rounded-pill badge-info">4</span><span class="badge rounded-pill badge-warning text-dark">5</span><span class="badge rounded-pill badge-danger">6</span><span class="badge rounded-pill badge-light text-dark">7</span><span class="badge rounded-pill badge-dark">8</span></div>
                  </div>
                </div>
              </div>
              <div class="col-sm-12 col-xl-6">
                <div class="card height-equal badges-as-part-buttons">
                  <div class="card-header pb-0">
                    <h5>Badges as part buttons</h5>
                  </div>
                  <div class="card-body">
                    <div class="mb-3">
                      <button class="btn btn-primary" type="button"><span>Messages </span><span class="badge rounded-pill badge-light text-dark"><i data-feather="mail"></i></span></button>
                    </div>
                    <div class="mb-3">
                      <button class="btn btn-secondary" type="button"><span>notifications </span><span class="badge rounded-pill badge-light text-dark"><i data-feather="bell"></i></span></button>
                    </div>
                    <div class="mb-3">
                      <button class="btn btn-success" type="button"><span>Update available </span><span class="badge rounded-pill badge-light text-dark"><i data-feather="settings"></i></span></button>
                    </div>
                    <div class="mb-3">
                      <button class="btn btn-info" type="button"><span>Playing Now </span><span class="badge rounded-pill badge-light text-dark"><i data-feather="music"></i></span></button>
                    </div>
                    <div class="mb-3">
                      <button class="btn btn-warning" type="button"><span>1.2 GB Used </span><span class="badge rounded-pill badge-light text-dark"><i data-feather="alert-triangle"></i></span></button>
                    </div>
                    <div>
                      <button class="btn btn-danger" type="button"><span>Alert </span><span class="badge rounded-pill badge-light text-dark"><i data-feather="alert-circle"></i></span></button>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-sm-12 col-xl-6">
                <div class="card height-equal badges-example-sec">
                  <div class="card-header pb-0">
