...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/bootstrap-basic-table.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:41:54 GMT -->
<head>
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5>Table head options</h5><span>Similar to tables and dark tables, use the modifier classes <code>.table-dark</code>  to make <code>thead</code> appear light or dark gray.</span>
                  </div>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5>Table head options</h5><span>Similar to tables and dark tables, use the modifier classes <code>.bg-*</code>and  <code>.table-light</code> to make <code>thead</code> appear light or dark gray.</span>
                  </div>
                  <div class="card-block row">
                    <div class="col-sm-12 col-lg-12 col-xl-12">
                      <div class="table-responsive">
