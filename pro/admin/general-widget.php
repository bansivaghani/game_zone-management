...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/general-widget.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:41:15 GMT -->
<head>
            ...
            <div class="row">
                ...
                <div class="card custom-profile">
                  <div class="pb-0">
                    ...
                    <ul class="card-social">
                      <li><a class="social-link" href="https://accounts.google.com/"><img class="user-img" src="https://admin.pixelstrap.com/zeta/assets/images/svg-icon/1.svg" alt=""></a></li>
                      <li><a class="social-link" href="https://www.facebook.com/"><img class="user-img" src="https://admin.pixelstrap.com/zeta/assets/images/svg-icon/2.svg" alt=""></a></li>
                      <li><a class="social-link" href="https://twitter.com/"><img class="user-img" src="https://admin.pixelstrap.com/zeta/assets/images/svg-icon/3.svg" alt=""></a></li>
                      <li><a class="social-link" href="https://www.instagram.com/"><img class="user-img" src="https://admin.pixelstrap.com/zeta/assets/images/svg-icon/4.svg" alt=""></a></li>
                      <li><a class="social-link" href="https://dashboard.rss.com/auth/sign-in/"><img class="user-img" src="https://admin.pixelstrap.com/zeta/assets/images/svg-icon/5.svg" alt=""></a></li>
                    </ul>
                  </div>
              ...
              <div class="col-sm-6 col-xl-3 xl-50 col-lg-6 box-col-6">
                <div class="card social-widget-card">
                  <div class="card-body">
                    <div class="media">
                      <div class="social-font"><img src="https://admin.pixelstrap.com/zeta/assets/images/svg-icon/2.svg" alt=""></div>
                      <div class="media-body">
                        <h4>Facebook</h4>
                      </div>
                    </div>
              ...
              <div class="col-sm-6 col-xl-3 xl-50 col-lg-6 box-col-6">
                <div class="card social-widget-card">
                  <div class="card-body">
                    <div class="media">
                      <div class="social-font"><img src="https://admin.pixelstrap.com/zeta/assets/images/svg-icon/3.svg" alt=""></div>
                      <div class="media-body">
                        <h4>Twitter</h4>
                      </div>
                    </div>
              ...
              <div class="col-sm-6 col-xl-3 xl-50 col-lg-6 box-col-6">
                <div class="card social-widget-card">
                  <div class="card-body">
                    <div class="media">
                      <div class="social-font"><img src="https://admin.pixelstrap.com/zeta/assets/images/svg-icon/6.svg" alt=""></div>
                      <div class="media-body">
                        <h4>Linkedin</h4>
                      </div>
                    </div>
              ...
              <div class="col-sm-6 col-xl-3 xl-50 col-lg-6 box-col-6">
                <div class="card social-widget-card">
                  <div class="card-body">
                    <div class="media">
                      <div class="social-font"><img src="https://admin.pixelstrap.com/zeta/assets/images/svg-icon/4.svg" alt=""></div>
                      <div class="media-body">
                        <h4>Instagram</h4>
                      </div>
                    </div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordernone">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div class="media">                             <img src="../assets/images/user/4.jpg" alt="">
                                <div class="media-body">
                          ...
                          <tr>
                            <td>
                              <div class="media"><img class="img-radius align-top m-r-15 rounded-circle" src="../assets/images/user/1.jpg" alt="">
                                <div class="media-body">
                          ...
                          <tr>
                            <td>
                              <div class="media"><img class="img-radius align-top m-r-15 rounded-circle" src="../assets/images/user/5.jpg" alt="">
                                <div class="media-body">
                          ...
                          <tr>
                            <td>
                              <div class="media"><img src="../assets/images/user/6.jpg" alt="">
                                <div class="media-body">
                          ...
                          <tr>
                            <td>
                              <div class="media"><img src="../assets/images/user/7.jpg" alt="">
                                <div class="media-body">
...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/general-widget.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:41:17 GMT -->
</html>