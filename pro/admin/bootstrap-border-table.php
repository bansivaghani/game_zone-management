...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/bootstrap-border-table.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:41:54 GMT -->
<head>
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5>Double Border</h5><span>Example of a <code>double</code> border inside table head. This border has <code>4px</code> width, Just add<code>table-double</code> with table for this default table.</span>
                  </div>
                  <div class="table-responsive">
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5>Dotted Border</h5><span>Example of a <code>dotted</code> border inside table head. This border has <code>2px</code> width, Just add<code>table-dotted</code> with table for this default table.</span>
                  </div>
                  <div class="table-responsive">
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5>Dashed Border</h5><span>Example of a <code>dashed</code> border inside table head. This border has <code>2px</code> width, Just add<code>table-dashed</code> with table for this default table.</span>
                  </div>
                  <div class="table-responsive">
