...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:42:02 GMT -->
<head>
                  ...
                  <div class="card-body">
                    <div class="grid-showcase">
                      ...
                      <div class="code-box-copy">
                        ...
                        <pre><code class="language-html" id="example-head7">&lt;!--  Grid Column Copy begin --&gt;
&lt;div class="row"&gt;
...
&lt;!--  Grid Column Copy end --&gt;</code></pre>
              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body"> 
                    <div class="grid-showcase">
                      <p>Use the responsive<code>.row-cols-*</code>classes to quickly set the number of columns that best render your content and layout. Whereas normal <code>.col-*</code>classes apply to the individual columns (e.g., .col-md-4), the row columns classes are set on the parent <code>.row</code>as a default for contained columns. With<code>.row-cols-auto</code>you can give the columns their natural width.</p>
                      <div class="row row-cols-2 row-cols-lg-3">
                        <div class="col"><span>col-lg-3</span></div>
                        <div class="col"><span>col-lg-3</span></div>
                        <div class="col"><span>col-lg-3</span></div>
                        <div class="col"><span>col-lg-3</span></div>
                        <div class="col"><span>col-lg-3</span></div>
                        <div class="col"><span>col-lg-3</span></div>
                        <div class="col-4 col-lg-2"><span>col-4 col-lg-2</span></div>
                        <div class="col-4 col-lg-2"><span>col-4 col-lg-2</span></div>
                        <div class="col-4 col-lg-2"><span>col-4 col-lg-2</span></div>
                        <div class="col-4 col-lg-2"><span>col-4 col-lg-2</span></div>
                        <div class="col-4 col-lg-2"><span>col-4 col-lg-2</span></div>
                      ...
                      <div class="code-box-copy">
                        ...
                        <pre><code class="language-html" id="example-head2">&lt;!--  Grid Column Copy begin --&gt;
&lt;div class="row"&gt;
  &lt;div class="col-md-1 text-center"&gt;
    &lt;span &gt;
       col-md-1
...
&lt;!--  Grid Column Copy end --&gt;</code></pre>
              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body"> 
                    <div class="grid-showcase grid-align pb-0">
                      ...
                      <div class="code-box-copy">
                        ...
                        <pre><code class="language-html" id="example-head3">&lt;!--  Vertical alignment Copy begin --&gt;
&lt;div class="row"&gt;
...
&lt;div class="row align-self-end"&gt;
  ...
  &lt;/div&gt;
&lt;/div&gt;;
&lt;!--  Vertical alignment Copy end --&gt;</code></pre>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body"> 
                    <div class="grid-showcase">
                      ...
                      <div class="code-box-copy">
                        ...
                        <pre><code class="language-html" id="example-head4">&lt;!--  Nesting Column Copy begin --&gt;
&lt;div class="row"&gt;
  ...
  &lt;/div&gt;
&lt;/div&gt;
&lt;!--  Nesting Column Copy end --&gt;</code></pre>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body"> 
                    <div class="grid-showcase">
                      ...
                      <div class="code-box-copy">
                        ...
                        <pre><code class="language-html" id="example-head5">&lt;!--  Order Copy begin --&gt;
&lt;div class="row"&gt;
  &lt;div class="col"&gt;
    &lt;span &gt;
       First, but unordered
                  ...
                  <div class="card-body"> 
                    <div class="grid-showcase">
                      ...
                      <div class="code-box-copy">
                        ...
                        <pre><code class="language-html" id="example-head6">&lt;!--  Offset Copy begin --&gt;
&lt;div class="row"&gt;
  &lt;div class="col-md-4"&gt;
    &lt;span &gt;
       col-md-4
