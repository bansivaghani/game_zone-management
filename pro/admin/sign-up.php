...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/sign-up.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:43:19 GMT -->
<head>
 ...
 <link rel="icon" href="../tmp/wp-content/uploads/2023/11/logo.webp" type="image/x-icon">
    <title> Game Zone admin dashboard </title>
    <!-- Google font-->
            ...
            <div class="login-card">
              <form class="theme-form login-form" action="" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="small-group">
                    <div class="input-group"><span class="input-group-text"><i class="bi bi-person"></i> </span>
                      <input class="form-control" type="text" required="" placeholder="Fist Name"  name="n">
                    </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group"><span class="input-group-text" ><i class="bi bi-envelope"></i>  <!-- Email icon -->
</span>
                    <input class="form-control" type="email" required="" placeholder="Test@gmail.com" name="e">
                  </div>
                </div>
                <div class="form-group">
                  <label>Password</label>
                  <div class="input-group"><span class="input-group-text"><i class="bi bi-lock"></i></i></span>
                    <input class="form-control" type="password" name="p" required="" placeholder="*********">
                ...
                <div class="form-group">
                  <button class="btn btn-primary btn-block" type="submit" name="btn">Create Account</button>
                </div>
                <div class="login-social-title">                
                  <h5>signup with</h5>
                </div>
                
                <p>Already have an account?<a class="ms-2" href="login.php" name="btn">Sign in</a></p>
              </form>
              <?php
...
if (isset($_POST['btn'])) {
extract($_POST);
$sql="INSERT INTO `login` (`id`, `name`, `gmail`,`password`) VALUES (NULL, '$n', '$e','$p');";
