...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/touchspin.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:41:53 GMT -->
<head>
            ...
            <div class="bootstrap-touchspin">
              <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-xl-6">
                  <div class="card">
                    <div class="card-header pb-0">
                      <h5 class="card-title">Large Horizontal Touchspin</h5><span>Add <code>.input-group-lg</code> class to input-group.</span>
                    </div>
                    <div class="card-body">
                      <fieldset>
                        <div class="input-group">
