...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/alert.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:42:02 GMT -->
<head>
          ...
          <div class="container-fluid">
            <div class="row">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="alert alert-dark" role="alert">
                      <p>This is a light alert—check it out!q</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-12 col-xl-6">
                <div class="card height-equal">
                  <div class="card-header pb-0">
                    <h5>Dismissing</h5><span>To animate alerts when dismissing them, be sure to add the <code>.fade </code>and <code>.show </code>classes.</span>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-sm-12 col-xl-6">
                <div class="card height-equal">
                  <div class="card-header pb-0">
                    <h5>Dismissing</h5><span>To animate alerts when dismissing them, be sure to add the <code>.fade </code>and <code>.show</code>class</span>
                  </div>
                  <div class="card-body">
