...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/datatable-ext-basic-button.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 11:42:00 GMT -->
<head>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
                    <h5 class="mb-3">Custom Button</h5><span>Fundamentally, each button is described by an object - this object is read by Buttons and displayed as appropriate. There are a number of parameters that Buttons will automatically look for in the button description object such as buttons.buttons.text and buttons.buttons.action which are the two fundamental parameters (button text and the action to take when activated).</span>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
                    <h5 class="mb-3">Page length</h5><span>he pageLength button acts in exactly the same way as the default length list and will inherit the options specified by the lengthMenu option</span>
                  </div>
                  <div class="card-body">
                    <div class="dt-ext table-responsive">
